...
struct edges_t {
       int*  vertices1= new int[819306];
       int*  vertices2= new int[819306];
} edges;

void print_coloring(int* colors, int vert_num) {
...
void better_coloring (int vert_num, int edge_num, edges_t edges) {
    ...
    for (int i=0; i<edge_num;i++){
        int col_v1 = colors[edges.vertices1[i]];
        int col_v2 = colors[edges.vertices2[i]];
        if( col_v1 == col_v2){
            if(col_v2 != d){
